  ...
  return (
    <div className="min-h-screen bg-[#F5F2ED] dark:bg-[#0A0502] text-[#1A1A1A] dark:text-[#E0D8D0] font-sans transition-colors duration-300 overflow-hidden flex flex-col">
      ...
      <motion.button
        ...
        className="fixed bottom-[calc(6rem+env(safe-area-inset-bottom,20px))] right-6 z-50 w-14 h-14 bg-[#141414] dark:bg-[#E0D8D0] text-[#E0D8D0] dark:text-[#141414] rounded-full shadow-2xl flex items-center justify-center hover:scale-105 transition-transform"
        id="add-book-fab"
      >
      ...
      {/* Bottom Navigation */}
      <nav className="fixed bottom-0 left-0 right-0 z-40 bg-white/80 dark:bg-[#151619]/80 backdrop-blur-xl border-t border-[#141414]/10 dark:border-white/10 px-6 py-4 pb-[calc(1rem+env(safe-area-inset-bottom,20px))] flex justify-around items-center rounded-t-3xl shadow-[0_-10px_25px_-5px_rgba(0,0,0,0.1)]">
        <NavButton
